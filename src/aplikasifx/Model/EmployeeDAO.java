...
public class EmployeeDAO {
    ...
    private static Employee getEmployeeFromResultSet(ResultSet rs) throws SQLException
    {
        ...
        if (rs.next()) {
            ...
            emp.setPhoneNumber(rs.getString("PHONE_INT"));
    ...
    //INSERT an employee
    //*************************************
    public static void insertEmp (String name, String lastname, String email, String jobid) throws SQLException, ClassNotFoundException {
        //Declare a DELETE statement
        String updateStmt =              
                        "INSERT INTO employees\n" +
                        "(FIRST_NAME, LAST_NAME, EMAIL, HIRE_DATE, JOB_ID)\n" +
                        "VALUES\n" +
                        "('"+name+"', '"+lastname+"','"+email+"', SYSDATE(),'"+jobid+"');\n";
